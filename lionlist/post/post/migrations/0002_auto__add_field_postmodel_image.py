...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PostModel.image'
        db.add_column('post_postmodel', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(default='/media/post_images/null.jpeg', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PostModel.image'
        db.delete_column('post_postmodel', 'image')
    ...
    models = {
        ...
        'post.postmodel': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'default': "'/media/post_images/null.jpeg'", 'max_length': '100', 'blank': 'True'}),
