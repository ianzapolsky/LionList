...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('post_postmodel', (
            ...
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['category.CategoryModel'])),
            ('forsale', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ...
            ('poster', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.UserProfile'])),
            ('poster_location', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('post', ['PostModel'])

        # Adding model 'BookModel'
        db.create_table('post_bookmodel', (
            ...
            ('isbn', self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True)),
            ('course', self.gf('smart_selects.db_fields.GroupedForeignKey')(to=orm['course.CourseModel'], group_field='department')),
        ))
        db.send_create_signal('post', ['BookModel'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('post_postmodel')

        # Deleting model 'BookModel'
        db.delete_table('post_bookmodel')
    ...
    models = {
        ...
        'course.coursemodel': {
            'Meta': {'ordering': "['slug']", 'object_name': 'CourseModel'},
        ...
        'post.bookmodel': {
            'Meta': {'object_name': 'BookModel', '_ormbases': ['post.PostModel']},
        ...
        'post.ticketmodel': {
            'Meta': {'object_name': 'TicketModel', '_ormbases': ['post.PostModel']},
