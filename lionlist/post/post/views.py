...
class PostDetailView(LoginRequiredMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if request.POST.get('post_title', False):
            ...
            msg = context['post'].title+" was successfully saved."
...
class PostCreateView(LoginRequiredMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        """ determine form type for specialized posts """
    ...
    def post(self, request, *args, **kwargs):
        ...
        if post_form.is_valid():
            ...
            messages.add_message(request, messages.INFO, msg)
            return HttpResponseRedirect(p.get_absolute_url()) ## change to success redirect
        else:
            return render_to_response('post/create.html', context, context_instance=RequestContext(self.request))


"""
generic post edit view
"""
...
class PostEditView(LoginRequiredMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        """ determine post and form type for specialized posts """
        if context['category'].name == 'books':
            context['post'] = get_object_or_404(BookModel, slug__iexact=self.kwargs['slug'])
    ...
    def post(self, request, *args, **kwargs):
        ...
        """ delete handling -- strong candidate for AJAX update """
