...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PostModel.image'
        db.alter_column('post_postmodel', 'image', self.gf('django.db.models.fields.files.ImageField')(default=0, max_length=100))

    def backwards(self, orm):

        # Changing field 'PostModel.image'
        db.alter_column('post_postmodel', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
