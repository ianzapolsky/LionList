...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('account_userprofile', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='uni@columbia.edu', max_length=75),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.email'
        db.delete_column('account_userprofile', 'email')
