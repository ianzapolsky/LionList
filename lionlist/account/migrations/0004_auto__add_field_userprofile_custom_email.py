...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.custom_email'
        db.add_column('account_userprofile', 'custom_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.custom_email'
        db.delete_column('account_userprofile', 'custom_email')


    models = {
        'account.userprofile': {
            'Meta': {'object_name': 'UserProfile'},
            'custom_email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'blank': 'True'}),
