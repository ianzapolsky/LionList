...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field saved_posts on 'UserProfile'
        m2m_table_name = db.shorten_name('account_userprofile_saved_posts')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['account.userprofile'], null=False)),
            ('postmodel', models.ForeignKey(orm['post.postmodel'], null=False))
        ))
        db.create_unique(m2m_table_name, ['userprofile_id', 'postmodel_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field saved_posts on 'UserProfile'
        db.delete_table(db.shorten_name('account_userprofile_saved_posts'))
